...
if _TORCH_FIDELITY_AVAILABLE:
    from utils.feature_extractor_inceptionv3_random import (
        FeatureExtractorInceptionV3Random as _FeatureExtractorInceptionV3,
    )
...
class NoTrainInceptionV3(_FeatureExtractorInceptionV3):
    ...
    def _torch_fidelity_forward(self, x: Tensor) -> Tuple[Tensor, ...]:
        ...
        x = self.Mixed_6e(x)
        conv_6 = x[:, :7, :, :]
        conv_6 = conv_6.reshape(conv_6.shape[0], -1)
        ...
        x = self.avgpool(x)
        pool_3 = x
        pool_3 = pool_3.reshape(pool_3.shape[0], -1)
...
class RandomFrechetInceptionDistance(Metric):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if isinstance(feature, int):
            ...
            valid_int_input = (64, 192, 768, 1734, 2048, 4071)
